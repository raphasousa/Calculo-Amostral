<?php
    ...
    if(isset($_POST['calcular'])){
        if (!empty($_POST['r_confianca'])) {
            ...
            else echo "<h3 class='erro'>Valor inválido para a Especificidade Esperada.</h3>";
        }
        else echo "<h3 class='erro'>Preencha todos os campos.</h3>";
    }
?>
...
<body>
    ...
    <div id="content">
        ...
        <h3 class="titulo">Estimativa da Especificidade</h3>
        ...
        <form method="POST">
            ...
            <?php $especificidade = (!empty($_POST['t_especificidade']) ? $_POST['t_especificidade'] : '0'); ?>
            <label for="t_especificidade" title="Qual o valor esperado para a especificidade na população.">Especificidade Esperada (%):</label>
            <input type="number" id="t_especificidade" name="t_especificidade" min="0" max="100" step="any" value="<?php echo $especificidade; ?>"><br />
