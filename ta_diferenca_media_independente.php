...
<body>
    ...
    <div id="content">
        ...
        <form method="POST">
            ...
            <label for="t_desvio" title="Qual o valor estimado do desvio padrão das populações em estudo. Pode ser estimado pela literatura ou por um piloto.">Estimativa do Desvio Padrão:</label>
